...
<div id="main-content">
    ...
    <?php
    include 'config.php';
//http://localhost/crud/edit.php?sid=2
    $stu_id = $_GET['sid'];
    //echo $stu_id;
    ...
    $id=$name=$class=$add=$phone="";
    $id=$row['sid'];
    $name=$row['sname'];
    //echo "Classid Is: ".$row['sclass'];
    //echo $id." name is: ".$name;
    ?>
    <form class="post-form" action="updatedata.php"
     method="post">
